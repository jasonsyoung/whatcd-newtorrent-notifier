...
var APP_NAME = "New Torrent Notifier",
	...
	LAST_UPDATE = getValue(UPDATE_KEY),
    ...
    win = window,
	doc = win.document,
    useLocalStorage = typeof localStorage !== 'undefined',
    useGMStorage = typeof GM_setValue !== 'undefined';
